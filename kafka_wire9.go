...
type OffFetchTXPart struct {
	ID uint32
}

type OffFetchTXTopic struct {
	Name		Str
	N		uint32
	Parition	[]OffFetchTXPart
}

type OffFetchTX struct {
	Group	Str
	N	uint32
	Topic	[]OffFetchTXTopic
}

type OffFetchRxPart struct {
	ID		uint32
	Offset		uint64
	MetaData	Str
	Err		uint16
...
type OffFetchRxTopic struct {
	Name	Str
	N	uint32
	Parts	[]OffFetchTXPart
}

type OffFetchRX struct {
	N	uint32
	Topic	OffFetchRxTopic
}
...
func (z *TX) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.ApiKey); err != nil {
		return err
	}

	if err := binary.Read(r, binary.BigEndian, &z.ApiVer); err != nil {
		return err
	}

	if err := binary.Read(r, binary.BigEndian, &z.CorrelationID); err != nil {
		return err
	}
...
func (z *TX) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.ApiKey); err != nil {
		return err
	}

	if err := binary.Write(w, binary.BigEndian, z.ApiVer); err != nil {
		return err
	}

	if err := binary.Write(w, binary.BigEndian, z.CorrelationID); err != nil {
		return err
	}
...
func (z *Record) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.Attr); err != nil {
		return err
	}
...
func (z *Record) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.Attr); err != nil {
		return err
	}
...
func (z *RecordBatch) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.Offset); err != nil {
		return err
	}

	if err := binary.Read(r, binary.BigEndian, &z.Len); err != nil {
		return err
	}

	if err := binary.Read(r, binary.BigEndian, &z.LeaderEpoch); err != nil {
		return err
	}

	if err := binary.Read(r, binary.BigEndian, &z.Magic); err != nil {
		return err
	}
	...
	if err := binary.Read(r, binary.BigEndian, &z.LastOffsetDelta); err != nil {
		return err
	}

	if err := binary.Read(r, binary.BigEndian, &z.FirstTime); err != nil {
		return err
	}

	if err := binary.Read(r, binary.BigEndian, &z.MaxTime); err != nil {
		return err
	}

	if err := binary.Read(r, binary.BigEndian, &z.ProdID); err != nil {
		return err
	}

	if err := binary.Read(r, binary.BigEndian, &z.ProdEpoch); err != nil {
		return err
	}

	if err := binary.Read(r, binary.BigEndian, &z.FirstSeq); err != nil {
		return err
	}
...
func (z *RecordBatch) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.Offset); err != nil {
		return err
	}

	if err := binary.Write(w, binary.BigEndian, z.Len); err != nil {
		return err
	}

	if err := binary.Write(w, binary.BigEndian, z.LeaderEpoch); err != nil {
		return err
	}

	if err := binary.Write(w, binary.BigEndian, z.Magic); err != nil {
		return err
	}
	...
	if err := binary.Write(w, binary.BigEndian, z.LastOffsetDelta); err != nil {
		return err
	}

	if err := binary.Write(w, binary.BigEndian, z.FirstTime); err != nil {
		return err
	}

	if err := binary.Write(w, binary.BigEndian, z.MaxTime); err != nil {
		return err
	}

	if err := binary.Write(w, binary.BigEndian, z.ProdID); err != nil {
		return err
	}

	if err := binary.Write(w, binary.BigEndian, z.ProdEpoch); err != nil {
		return err
	}

	if err := binary.Write(w, binary.BigEndian, z.FirstSeq); err != nil {
		return err
	}
...
func (z *Broker) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.ID); err != nil {
		return err
	}
	...
	if err := binary.Read(r, binary.BigEndian, &z.Port); err != nil {
		return err
	}
...
func (z *Broker) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.ID); err != nil {
		return err
	}
	...
	if err := binary.Write(w, binary.BigEndian, z.Port); err != nil {
		return err
	}
...
func (z *MetaPart) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.Err); err != nil {
		return err
	}
	...
	if err := binary.Read(r, binary.BigEndian, &z.Leader); err != nil {
		return err
	}

	if err := binary.Read(r, binary.BigEndian, &z.Replicas); err != nil {
		return err
	}

	if err := binary.Read(r, binary.BigEndian, &z.ISR); err != nil {
		return err
	}
...
func (z *MetaPart) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.Err); err != nil {
		return err
	}
	...
	if err := binary.Write(w, binary.BigEndian, z.Leader); err != nil {
		return err
	}

	if err := binary.Write(w, binary.BigEndian, z.Replicas); err != nil {
		return err
	}

	if err := binary.Write(w, binary.BigEndian, z.ISR); err != nil {
		return err
	}
...
func (z *MetaTopicRX) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.M); err != nil {
		return err
	}
...
func (z *MetaTopicRX) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.M); err != nil {
		return err
	}
...
func (z *ProdTXPart) ReadBinary(r io.Reader) (err error) {
	...
	z.MessageSet = make([]byte, int(z.N))

	if n, err := r.Read(z.MessageSet); err != nil || n != int(z.N) {
		return err
	}
...
func (z *ProdTXPart) WriteBinary(w io.Writer) (err error) {
	...
	{
		x := int(z.N)
		if n, err := w.Write(z.MessageSet[:x]); err != nil || n != x {
			return err
		}
	}
	return nil
...
func (z *ProdTX) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.NeedAcks); err != nil {
		return err
	}

	if err := binary.Read(r, binary.BigEndian, &z.Timeout); err != nil {
		return err
	}
...
func (z *ProdTX) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.NeedAcks); err != nil {
		return err
	}

	if err := binary.Write(w, binary.BigEndian, z.Timeout); err != nil {
		return err
	}
...
func (z *ProdRXPart) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.Time); err != nil {
		return err
	}
...
func (z *ProdRXPart) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.Time); err != nil {
		return err
	}
...
func (z *ProdRX) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.ThrottleTime); err != nil {
		return err
	}
...
func (z *ProdRX) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.ThrottleTime); err != nil {
		return err
	}
...
func (z *FetchTXPart) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.MaxBytes); err != nil {
		return err
	}
...
func (z *FetchTXPart) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.MaxBytes); err != nil {
		return err
	}
...
func (z *FetchTX) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.ReplicaId); err != nil {
		return err
	}

	if err := binary.Read(r, binary.BigEndian, &z.MaxWait); err != nil {
		return err
	}

	if err := binary.Read(r, binary.BigEndian, &z.MinBytes); err != nil {
		return err
	}
...
func (z *FetchTX) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.ReplicaId); err != nil {
		return err
	}

	if err := binary.Write(w, binary.BigEndian, z.MaxWait); err != nil {
		return err
	}

	if err := binary.Write(w, binary.BigEndian, z.MinBytes); err != nil {
		return err
	}
...
func (z *FetchRXPart) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.HiWater); err != nil {
		return err
	}
...
func (z *FetchRXPart) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.HiWater); err != nil {
		return err
	}
...
func (z *OffsetTXPart) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.MaxOffsets); err != nil {
		return err
	}
...
func (z *OffsetTXPart) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.MaxOffsets); err != nil {
		return err
	}
...
func (z *Offset) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.Q0); err != nil {
		return err
	}
...
func (z *Offset) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.Q0); err != nil {
		return err
	}
...
func (z *CommitTX) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.Gen); err != nil {
		return err
	}
	...
	if err := binary.Read(r, binary.BigEndian, &z.Retain); err != nil {
		return err
	}
...
func (z *CommitTX) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.Gen); err != nil {
		return err
	}
	...
	if err := binary.Write(w, binary.BigEndian, z.Retain); err != nil {
		return err
	}
...
func (z *OffFetchTXPart) ReadBinary(r io.Reader) (err error) {
	defer func() { recover() }()
	if z == nil {
		return fmt.Errorf("ReadBinary: z nil")
	}
...
func (z *OffFetchTXPart) WriteBinary(w io.Writer) (err error) {
	defer func() { recover() }()
...
func (z *OffFetchTXTopic) ReadBinary(r io.Reader) (err error) {
	defer func() { recover() }()
	if z == nil {
		return fmt.Errorf("ReadBinary: z nil")
	}
	...
	z.Parition = make([]OffFetchTXPart, int(z.N))
	for i := 0; i < int(z.N); i++ {
...
func (z *OffFetchTXTopic) WriteBinary(w io.Writer) (err error) {
	defer func() { recover() }()
...
func (z *OffFetchTX) ReadBinary(r io.Reader) (err error) {
	defer func() { recover() }()
	if z == nil {
		return fmt.Errorf("ReadBinary: z nil")
	}
	...
	z.Topic = make([]OffFetchTXTopic, int(z.N))
	for i := 0; i < int(z.N); i++ {
...
func (z *OffFetchTX) WriteBinary(w io.Writer) (err error) {
	defer func() { recover() }()
...
func (z *OffFetchRxPart) ReadBinary(r io.Reader) (err error) {
	defer func() { recover() }()
	if z == nil {
		return fmt.Errorf("ReadBinary: z nil")
	}
...
func (z *OffFetchRxPart) WriteBinary(w io.Writer) (err error) {
	defer func() { recover() }()
...
func (z *OffFetchRxTopic) ReadBinary(r io.Reader) (err error) {
	defer func() { recover() }()
	if z == nil {
		return fmt.Errorf("ReadBinary: z nil")
	}
	...
	z.Parts = make([]OffFetchTXPart, int(z.N))
	for i := 0; i < int(z.N); i++ {
...
func (z *OffFetchRxTopic) WriteBinary(w io.Writer) (err error) {
	defer func() { recover() }()
...
func (z *OffFetchRX) ReadBinary(r io.Reader) (err error) {
	defer func() { recover() }()
	if z == nil {
		return fmt.Errorf("ReadBinary: z nil")
	}
...
func (z *OffFetchRX) WriteBinary(w io.Writer) (err error) {
	defer func() { recover() }()
...
func (z *JoinGroupTX) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.RebalanceTimeout); err != nil {
		return err
	}
...
func (z *JoinGroupTX) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.RebalanceTimeout); err != nil {
		return err
	}
...
func (z *JoinGroupRX) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.GenID); err != nil {
		return err
	}
...
func (z *JoinGroupRX) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.GenID); err != nil {
		return err
	}
...
func (z *ListGroupsTX) ReadBinary(r io.Reader) (err error) {
	...
	if err := binary.Read(r, binary.BigEndian, &z.Zero); err != nil {
		return err
	}
...
func (z *ListGroupsTX) WriteBinary(w io.Writer) (err error) {
	...
	if err := binary.Write(w, binary.BigEndian, z.Zero); err != nil {
		return err
	}
